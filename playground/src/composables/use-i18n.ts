...
const dict: Record<string, Record<string, string>> = {
  ...
  'segmented': { en: 'Segmented', zh: '分段选择' },
  'segmented.desc': { en: 'Inline segmented control with options', zh: '内联分段控件，可选项数组驱动' },
  ...
  'tag': { en: 'Tag', zh: '标签' },
  'tag.desc': { en: '5 types + closeable + round + dashed variant', zh: '5 种类型 + 可关闭 + 圆角 + 虚线边框' },
  'fab': { en: 'FAB', zh: '悬浮按钮' },
  'fab.desc': { en: 'Floating action button with speed-dial', zh: '悬浮操作按钮，支持速拨菜单' },
