...
export { TtNotify, notifyProps, notify, closeNotify, notifyState, openNotify } from './components/tt-notify'
export type { TtNotifyProps as NotifyProps, NotifyType, NotifyPosition, NotifyFn, NotifyOptions } from './components/tt-notify'
