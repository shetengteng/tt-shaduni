...
.tt-typography--text { font-size: 14px; line-height: 1.6; }
.tt-typography--title { font-weight: 700; }
.tt-typography--h1 { font-size: 30px; line-height: 1.2; }
.tt-typography--h2 { font-size: 24px; line-height: 1.3; }
.tt-typography--h3 { font-size: 20px; line-height: 1.35; }
.tt-typography--h4 { font-size: 16px; line-height: 1.4; }
.tt-typography--h5 { font-size: 14px; line-height: 1.5; }
.tt-typography--link { color: var(--tt-primary, #171717); font-size: 14px; }
